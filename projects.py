...
# ---- PROJECTS ----
    with st.container():
        ...
        with image_column:
            st.markdown(f'<img src="{mrs_img}" style="{image_style2}">',unsafe_allow_html=True)
        ...
        with text_column:
            ...
            st.write(
                ...
                """)
            st.markdown('[Github](https://github.com/amang3196/collaborative-filtering-recommender-system)&nbsp;&nbsp;&nbsp;[Demo](https://content-based-movie-recommender-system.streamlit.app/)')
